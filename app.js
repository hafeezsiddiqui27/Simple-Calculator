...
let answers = await inquirer.prompt([
    { message: (chalk.red `enter first number`), type: `number`, name: `firstnumber` },
    { message: (chalk.red `enter second number`), type: `number`, name: `secondnumber` },
    {
...
if (answers.operator === `Addition`) {
    console.log(chalk.bold.greenBright(`your answer is `, answers.firstnumber + answers.secondnumber));
}
